        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="w-100 p-5" style="background-color:#533E6D; height:700px;">
                    ...
                    <input type="text" id="inputPassword5" class="fw-bold form-control" style="background-color:#684F86; color:white;" aria-describedby="passwordHelpBlock">
                    <br>
                    <label for="inputPassword5" class="fw-bold form-label" style="color:white;">Code title:</label>
                    <input type="text" id="CodeTitle" class="fw-bold form-control" style="background-color:#684F86;color:white;" aria-describedby="passwordHelpBlock">
                    <br>
                    <div class="form-floating">
